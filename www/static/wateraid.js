...
/*function type_ofActivity2(){
	var service_level_xsector=$("#service_level_xsector").val();
	if (servicType=='X-Sector' && service_level_xsector=='Event'){
		$("#availHandWash_fac").hide();
		$("#availWaterSoap_fac").hide();
		$("#typeOfEvent").show();	
	}else{
